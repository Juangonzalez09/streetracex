    ...
    try {
      ...
      return res.status(201).json({
        ...
        data: {
          ...
          zonaLocalidad: newUser.zonaLocalidad,
          zonaCiudad: newUser.zonaCiudad,
          zonaEstado: newUser.zonaEstado,
          zonaPais: newUser.zonaPais,
          victorias: newUser.victorias,
          derrotas: newUser.derrotas,
          retosConsecutivos: newUser.retosConsecutivos,
